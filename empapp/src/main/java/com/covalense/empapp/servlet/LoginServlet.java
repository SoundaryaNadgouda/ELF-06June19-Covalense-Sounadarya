...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		session1.setAttribute("soundarya", bean);
		if (session1 == null) {
 ...
 bean = dao.getEmployeeInfo(Integer.parseInt(req.getParameter("id")));
		if (bean.getPassword() == null) {
			resp.sendRedirect("http://localhost/empapp/login.html?error=invalid");
